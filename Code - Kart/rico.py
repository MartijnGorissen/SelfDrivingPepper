...
def main():
    ...
    # Breken van de loop wanneer ctrl + C in terminal wordt uitgevoerd
    except KeyboardInterrupt:
        pass

    # Geef een melding dat het stoppen begint
...
# Start de hoofdfunctie als dit script rechtstreeks wordt uitgevoerd
